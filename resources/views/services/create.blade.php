                    ...
                    <form action="{{ route('organization.services.store', $organization) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <x-text-input id="duration" class="block mt-1 w-full" type="number" name="duration" :value="old('duration', 30)" required min="5" max="480" />
                            ...
                            <div>
                                ...
                                <x-text-input id="price" class="block mt-1 w-full" type="number" step="0.01" name="price" :value="old('price')" required min="0" placeholder="0.00" />
