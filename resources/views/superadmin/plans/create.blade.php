                    ...
                    <form action="{{ route('superadmin.plans.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="duration_days" class="block mt-1 w-full" type="number" name="duration_days" :value="old('duration_days', 30)" required />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <x-text-input id="max_services" class="block mt-1 w-full" type="number" name="max_services" :value="old('max_services')" />
                            ...
                            <div>
                                ...
                                <x-text-input id="max_team_members" class="block mt-1 w-full" type="number" name="max_team_members" :value="old('max_team_members')" />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <x-text-input id="max_bookings_per_month" class="block mt-1 w-full" type="number" name="max_bookings_per_month" :value="old('max_bookings_per_month')" />
                                <x-input-error :messages="$errors->get('max_bookings_per_month')" class="mt-2" />
                            </div>

                            <div class="flex items-center mt-6">
                                <input id="is_active" type="checkbox" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }} class="rounded dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-indigo-600 shadow-sm focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:focus:ring-offset-gray-800">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="space-y-2">
                                <div class="flex items-center">
                                    <input id="custom_branding" type="checkbox" name="features[]" value="custom_branding" {{ in_array('custom_branding', old('features', [])) ? 'checked' : '' }} class="rounded dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-indigo-600 shadow-sm focus:ring-indigo-500">
                                    <label for="custom_branding" class="ml-2 text-sm text-gray-600 dark:text-gray-400">Custom Branding</label>
                                </div>
                                <div class="flex items-center">
                                    <input id="analytics" type="checkbox" name="features[]" value="analytics" {{ in_array('analytics', old('features', [])) ? 'checked' : '' }} class="rounded dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-indigo-600 shadow-sm focus:ring-indigo-500">
                                    <label for="analytics" class="ml-2 text-sm text-gray-600 dark:text-gray-400">Analytics Dashboard</label>
                                </div>
                                <div class="flex items-center">
                                    <input id="priority_support" type="checkbox" name="features[]" value="priority_support" {{ in_array('priority_support', old('features', [])) ? 'checked' : '' }} class="rounded dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-indigo-600 shadow-sm focus:ring-indigo-500">
